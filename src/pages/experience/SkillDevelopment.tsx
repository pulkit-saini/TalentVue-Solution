import { BookOpen, Users, Award, TrendingUp, Target, Briefcase, Layers } from "lucide-react";
...
const SkillDevelopment = () => {
  const programs = [
    ...
    {
      icon: Layers,
      title: "Specialized Training for Multiple Industry Domains",
      description: "Our curriculum covers major domains including Electrical, Automotive, Retail, Logistics, Apparel, Tourism, and Telecommunications, ensuring participants gain sector-aligned knowledge and hands-on expertise essential for real-world workforce demands.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto animate-fade-in">
            <p className="text-lg text-muted-foreground text-center mb-12">
              At TalentVue Solutions Pvt. Ltd., we understand that skilled workforce is the cornerstone of organizational success. 
