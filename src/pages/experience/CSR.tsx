        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto animate-fade-in">
            <p className="text-lg text-muted-foreground text-center mb-12">
              At TalentVue Solutions Pvt. Ltd., we believe in the power of responsible business practices to drive meaningful change. 
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <div className="space-y-8">
                ...
                <div className="relative flex items-start gap-6 animate-slide-up" style={{ animationDelay: '500ms' }}>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-lg z-10">
                    6
                  </div>
                  <Card className="flex-1">
